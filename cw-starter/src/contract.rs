...
pub fn execute(
    ...
    fn execute_vote(
        ...
        if poll.is_none() {
            return Err(ContractError::PollNotFound { poll_id});
        }
...
mod tests {
    ...
    use crate::msg::{ ExecuteMsg, InstantiateMsg, QueryMsg, AllPollsResponse, PollResponse, VoteResponse}; // our instantate method
